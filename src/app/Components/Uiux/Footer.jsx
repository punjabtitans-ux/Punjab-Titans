...
const Footer = () => {
  ...
  return (
    ...
    >
      <div className="cus_container py-24">
        <div className="max-w-[90%] m-auto flex gap-10 2xl:gap-20">
          <Image
            src={Logo}
            alt="Logo"
            width={1000}
            height={500}
            className="max-w-[150px] 2xl:max-w-[202px] object-contain"
          />
          <div className="grid grid-cols-[2fr_3fr] py-8 2xl:py-12 bg-primary px-6 2xl:px-10 rounded-4xl">
            <div>
            ...
            <div className="flex justify-end items-start">
              <div className="bg-white w-[95%] flex justify-between py-1 ps-6 pe-1 rounded-2xl">
                <form className="flex justify-between w-full">
                  <input
                    type="email"
                    name=""
                    id=""
                    className="outline-none w-[50%] text-lg 2xl:text-xl"
      ...
      <div className="bg-primary py-6 2xl:py-10">
            ...
            <div className="flex items-center gap-20">
              {
                footerdata.map((data,index)=>(
                  ...
                  key={index}
                   href={data.page_link}>
                   <span className="text-[19px] text-white">{data.page_name}</span>
                  </Link>
                ))
              }
            </div>
       ...
       <div className="pt-12 2xl:pt-16 pb-6 2xl:pb-8">
        <div className="cus_container">
          <div className="max-w-[90%] m-auto flex items-center justify-between">
            <div>
