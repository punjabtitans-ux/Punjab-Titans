...
const Footer = () => {
  return (
    ...
    >
      <div className="py-4 bg-primary border-b-2 border-[#DDBE68] mb-0 md:mb-8  hidden md:block">
        ...
        <div className="md:hidden">
          <div className="flex flex-row justify-between items-center gap-3 md:gap-18 bg-ternary px-4 py-3">
              <div className="flex gap-4">
                <Link href={"/terms-and-conditions"}>
              ...
              <div className="flex items-center gap-3 md:gap-6">
                <Link target="_blank" href={"https://www.instagram.com/punjabtitansofficial/"}>
                  <Image
                    ...
                    width={1000}
                    height={500}
                    className="max-w-[16px] md:max-w-[22px]"
                  />
                </Link>
                <Link target="_blank" href={"https://www.youtube.com/channel/UCrdoKCkBQTYfGQVOhFbNAwA"}>
                  <Image
                    ...
                    width={1000}
                    height={500}
                    className="max-w-[21px] md:max-w-[29px]"
                  />
                </Link>
                <Link target="_blank" href={"https://www.facebook.com/profile.php?id=61583443735600"}>
                  <Image
