...
const Overallstats = () => {
  ...
  return (
    <div ref={ref} className="cus_container px-0! md:px-auto pt-6 md:pt-auto md:py-12 2xl:py-16">
      <div className="max-w-6xl m-auto grid grid-cols-3 md:grid-cols-3 md:gap-3">
        
        <div className="text-center md:w-full border-r md:border-r-0 border-[#999]">
